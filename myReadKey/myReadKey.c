  ...
  if (read_bytes == 3)
    {
      switch ((enum KEYS)buf[2])
        {
        case 0x41:
          *value = KEYS_NAME[KEY_TOP];
          return 0;
        case 0x42:
          *value = KEYS_NAME[KEY_BOTTOM];
          return 0;
        case 0x43:
          *value = KEYS_NAME[KEY_RIGHT];
          return 0;
        case 0x44:
          *value = KEYS_NAME[KEY_LEFT];
          return 0;
        case 0x51:
          *value = KEYS_NAME[KEY_F2];
          return 0;
        case 0x53:
          *value = KEYS_NAME[KEY_F4];
          return 0;
        }
    }
...
void
rk_accumulator_to_string (char *hex)
{
  int value;
